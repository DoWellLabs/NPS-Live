...
export default function Sidebar({
  ...
  const handleUnLikelyRate = (e) => {
    ...
    setAttributes({ state: { ...state, bar: bar, unlikelyRate: newColor } });
  };
  ...
  const handleNeutralRate = (e) => {
    ...
    setAttributes({ state: { ...state, bar: bar, neutralRate: newColor } });
  };
  ...
  const handleVeryLikelyRate = (e) => {
    ...
    setAttributes({ state: { ...state, bar: bar, veryLikelyRate: newColor } });
  };
  ...
  const handleShowLabel = (e) => {
    ...
    setAttributes({ state: { ...state, bar: bar, showLabel: newColor } });
  };
