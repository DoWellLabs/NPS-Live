...
function PieChartFrontEnd(_ref) {
  ...
  const [scaleId, setScaleId] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(null);
  const [score, setScore] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(null);
  const [isLoading, setIsLoading] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(true);
  const scoresRef = (0,react__WEBPACK_IMPORTED_MODULE_1__.useRef)(null);
  const {
    state
  } = state_back_end;
  let {
  ...
  const fetchScaleId = async () => {
    try {
      setIsLoading(true);
      const resp = await axios__WEBPACK_IMPORTED_MODULE_2___default().get(`https://100035.pythonanywhere.com/api/plugins/?scale_type=nps&api_key=1b834e07-c68b-4bf6-96dd-ab7cdc62f07f&type=settings`);
  ...
  const fetchScore = async () => {
    try {
      setIsLoading(true);
      const responseScore = await axios__WEBPACK_IMPORTED_MODULE_2___default().get(`https://100035.pythonanywhere.com/api/plugins/?api_key=1b834e07-c68b-4bf6-96dd-ab7cdc62f07f&scale_type=nps&type=response&scale_id=${scaleId}`);
      // setScaleId(resp.data.scale_id);
  ...
  return (
    ...
    (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      ...
      className: "loader"
    }) : bar ? (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(react_chartjs_2__WEBPACK_IMPORTED_MODULE_5__.Bar, {
      data: data,
      width: 30,
      height: 30
    }) : (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(react_chartjs_2__WEBPACK_IMPORTED_MODULE_5__.Pie, {
      data: data,
      width: 30,
      height: 30
    })))
