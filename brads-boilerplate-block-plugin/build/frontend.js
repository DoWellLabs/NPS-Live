...
/* harmony export */   "default": function() { return /* binding */ Scalefrontend; }
/* harmony export */ });
...
function Scalefrontend({
  ...
  const [selectedScore, setSelectedScore] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)({
    value: null
  });
  const [scaleId, setScaleId] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(null);
  ...
  const fetchScaleId = async () => {
    try {
      const resp = await axios__WEBPACK_IMPORTED_MODULE_2__["default"].get(`https://100035.pythonanywhere.com/api/plugins/?scale_type=nps&type=settings&api_key=1b834e07-c68b-4bf6-96dd-ab7cdc62f07f&block_id=${blockData}`);
  ...
  const updateScale = async () => {
    ...
    try {
      ...
      const updateResponse = await axios__WEBPACK_IMPORTED_MODULE_2__["default"].put("https://100035.pythonanywhere.com/api/plugins/?scale_type=nps&type=settings&api_key=1b834e07-c68b-4bf6-96dd-ab7cdc62f07f", updateScaleData);
  ...
  const getUniqueID = async () => {
    ...
    const {
      instance_ids
    } = (await axios__WEBPACK_IMPORTED_MODULE_2__["default"].get(`https://100035.pythonanywhere.com/api/plugins/?api_key=1b834e07-c68b-4bf6-96dd-ab7cdc62f07f&scale_type=nps&type=response&scale_id=${scaleId}`)).data;
  ...
  const userResponse = async () => {
    ...
    getUniqueID().then(async res => {
      ...
      try {
        ...
        const feedbackResponse = await axios__WEBPACK_IMPORTED_MODULE_2__["default"].post(`https://100035.pythonanywhere.com/api/plugins/?api_key=1b834e07-c68b-4bf6-96dd-ab7cdc62f07f&scale_type=nps&type=response`, userResponseFeedback);
  ...
  const buttonStyle = {
    ...
    //transform:`${state.scaleOrientation ? state.scaleOrientation === 'vertical' ? '':'' : row ? '' : ''}`
  ...
  const scaleDir = (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    style: {
      flexDirection: `${state.scaleOrientation === "vertical" ? "column" : "row"}`,
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(re_resizable__WEBPACK_IMPORTED_MODULE_1__.Resizable, {
    defaultSize: {
  ...
  }, state.scale.question), state.scaleOrientation === "vertical" ? (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    style: {
      display: "flex",
      flexDirection: "row",
...
/* harmony import */ var _Scalefrontend__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./Scalefrontend */ "./src/Scalefrontend.js");
...
divsToUpdate.forEach(div => {
  ...
  // console.log(data);
  react_dom__WEBPACK_IMPORTED_MODULE_3___default().render((0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_components_ScaleContext__WEBPACK_IMPORTED_MODULE_4__.ScaleProvider, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(OurComponent, {
    ...data
  })), div);
...
function OurComponent({
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Scalefrontend__WEBPACK_IMPORTED_MODULE_6__["default"], {
    state_back_end: {
      state: state
    }
  }));
