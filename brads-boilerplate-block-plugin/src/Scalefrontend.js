...
export default function Scalefrontend({ state_back_end }) {
  ...
  const buttonStyle = {
    background: state.color.btnColor
      ...
      ? btnbg
      : "rgb(142, 216, 142)",
    color: state.color.fntColor
      ? state.color.fntColor
      : btncolr
      ? btncolr
      : "white",
  ...
  let emojiColor = state.color.btnColor
    ? state.color.btnColor
    : btnbg
    ? btnbg
    : "rgb(142, 216, 142)";
        ...
        >
          {emoji ? (
            ...
            >
              ...
              <defs>
                <clipPath id="clip0_386_596">
                  <rect width="21.9355" height="21.9355" fill="white" />
                </clipPath>
              </defs>
            </svg>
          ) : (
...
{!emoji && <button className='btn' style={buttonStylecond}>10</button> } */}
      ...
      >
        <label
          ...
          style={{ color: `${state.color.confgrFontColor}` }}
        >
          {state.scale.lblLeft}
        </label>
        <label
  ...
  return (
    ...
    >
      ...
      >
        ...
        {state.scaleOrientation === "vertical" ? (
          <>
            <div
              style={{
                display: "flex",
