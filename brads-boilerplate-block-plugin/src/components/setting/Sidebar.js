  ...
  const createScale = async () => {
    try {
      ...
      const postData = {
        ...
        user: "yes",
        position: [{ page: 25, block: blockId }],
      };
        ...
        <div className="sidebar">
          <div className="setting_configure">
            <button
              ...
              style={{ borderBottom: `${setting ? "3px solid #6E62E5" : ""}` }}
            >
              Setting
            </button>
            <button
          ...
          <div className="sidebar_setting">
            ...
            {setting ? (
              <>
                <div className="sidebar_element--one">
                  <label for="scale_orient" className="orient_label">
                    Scale Orientation
                  </label>
                  <select
                    id="scale_orient"
                    ...
                    value={
                      state.scaleOrientaion === "horizontal"
                        ? "Horizontal"
                        : "Vertical"
                    }
                    onChange={(e) => {
                      ...
                      setAttributes({
                        state: { ...state, scaleOrientation: orientation },
                      });
                    }}
                  >
                ...
                <div className="sidebar_element_five">
                  <div className="scale_width">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        handleScaleDimensionsChange("width", e.target.value)
                      }
                    />
                  </div>
                  <div className="scale_height">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        handleScaleDimensionsChange("height", e.target.value)
                      }
                    />
                  </div>
                </div>
                  ...
                  <div className="label_position">
                    ...
                    <div className="scale_label--center">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          handleLabelChange("center", e.target.value)
                        }
                      />
                    </div>
                  </div>
            ...
            <button onClick={hideSetting} className="use_scale">
              Use Scale
            </button>
          </div>
        </div>
