...
const App = ({ setAttributes }) => {
  ...
  const [scaleSettingAbout, setScaleSettingAbout] = useState(true);
  const [scaleSettingNotification, setScaleSettingNotification] =
    useState(false);
  const [scaleSettingCredit, setScaleSettingCredit] = useState(false);
  const [scaleSettingPrivacy, setScaleSettingPrivacy] = useState(false);
  const [scaleTemplate, setScaleTemplate] = useState(true);
  const [scalePluginSetting, setScalePluginSetting] = useState(false);
      ...
      {scalePluginSetting && (
        <>
          <div className="scalecontainer">
            <div className="scaleplugin__container">
              <div className="scaleplugin__header">
                <div className="scaleflex">
                  <div onClick={closeSCalePluginSetting}>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="32"
                      height="32"
                  ...
                  <h2 className="scalecolor">Plugin Settings </h2>
                </div>
            ...
            <div className="scalestyle">
              <aside className="scaleaside">
                <div
                  onClick={ScaleAboutHandler}
                  className={
                    scaleSettingAbout === true
                      ? "scaleselectedabout"
                      : "scaleabout"
                  }
                >
                  ...
                  <span
                    className={
                      scaleSettingAbout === true ? "scalespanns" : "scalespann"
                    }
                  >
                    About Plugin{" "}
                  </span>
                ...
                <div
                  ...
                  className={
                    scaleSettingCredit === true
                      ? "scaleselectedaboutplugin"
                      : "scaleaboutplugin"
                  }
                >
                  {" "}
                  ...
                  >
                    <g clip-path="url(#clip0_721_106)">
                      <path
                        ...
                        fill={
                          scaleSettingCredit === true ? "#6E62E5" : "#5E6267"
                        }
                      />
                      <path
                ...
                >
                  ...
                  >
                    <path
                      ...
                      fill={
                        scaleSettingPrivacy === true ? "#6E62E5" : "#5E6267"
                      }
                    />
                    <path
                ...
                <button className="scalebtnn">Download Reports</button>
              </aside>
              <section className=" scalesection">
                {scaleSettingNotification && (
                  <>
                    <h1>Upgrade Nps Report</h1>
                    <div className="scalecontent">
                      <p className="scaleparagraph1">
                        Upgrade Plan for unlimited access of exciting features.
                      </p>
                      {/* <h3>hello</h3> */}
                      <button className="scalepluginbtn">view plans</button>
                    </div>
                  </>
                )}
                ...
                {scaleSettingCredit && (
                  <>
                    ...
                    <div className="scalecontent">
                      ...
                      {/* <h3>hello</h3> */}
                      <button className="scalepluginbtn">
                        Enable Purchase
                      </button>
                    </div>
                  </>
